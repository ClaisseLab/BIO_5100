...
1.  [Principal Component Analysis (PCA) - easy and practical explanation (11 min overview video)](https://youtu.be/5vgP05YpKdE)
...
2.  [PCA example using `rda()` and `ggplot2`(Longer 40 min video) ](https://youtu.be/Tjxgd9FLeYc)

    Watch at least the first ~15 minutes before class. Continue through the remaining plotting examples if you have time.

For an additional conceptual review of PCA (if/when you want further details on how PCA works) see [StatQuest: PCA step-by-step](https://www.youtube.com/watch?v=FgakZw6K1QQ).
