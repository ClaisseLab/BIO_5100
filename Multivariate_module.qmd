---
title: "multivariate ecological data analysis module"
toc: true
toc-title: "On this page"
---

# Summarizing and exploring the your data
...
The introductory script demonstrates how to:
...
- [Introduction to multivariate data analysis using vegan](https://www.youtube.com/live/tVnnG7mFeqA) is a roughly three-hour workshop by a `vegan` author demonstrating what the package can do. The nMDS material begins around 2:00:00
- [Applied Multivariate Statistics in R: nMDS](https://uw.pressbooks.pub/appliedmultivariatestatistics/chapter/nmds/) provides a more detailed explanation.
