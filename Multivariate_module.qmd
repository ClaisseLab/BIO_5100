...
- [Download the mite nMDS practice script](downloads/mite_nMDS_practice.R){download}
...
- [Longer PCA example using `rda()` and `ggplot2`](https://youtu.be/Tjxgd9FLeYc) — watch at least the first 20-30 minutes before class. Continue through the remaining plotting examples if you have time.
