...
<https://benchbiostats.com/chapters/intro-stat-modeling.html#modeling-strategy>
...
Note this code/process is adapted from: <https://benchbiostats.com/chapters/one-factor.html>
...
<https://benchbiostats.com/chapters/intro-stat-modeling.html#assumptions-for-inference-with-a-statistical-model>
...
More detail on what is in the coefficient table here: <https://benchbiostats.com/chapters/one-factor.html#the-estimates-in-the-coefficient-table-are-estimates-of-the-parameters-of-the-linear-model-fit-to-the-data.>
...
For more explanation see: <https://benchbiostats.com/chapters/one-factor.html#the-emmeans-table-is-a-table-of-modeled-means-and-inferential-statistics>
...
plot_lm_bw_island_emm <- dat_bw |>
  ...
  geom_crossbar(
    data = as_tibble(lm_bw_island_emm),
    aes(
      y = emmean,
      ymin = lower.CL,
      ymax = upper.CL
...
<https://benchbiostats.com/chapters/multiple-testing.html>

And see for specific posthoc tests:

<https://benchbiostats.com/chapters/two-factors.html#twoway-multiple-tests>
...
For more explanation see: <https://benchbiostats.com/chapters/one-factor.html#estimates-of-the-effects-are-in-the-contrasts-table>
...
According to: <https://benchbiostats.com/chapters/two-factors.html#twoway-multiple-tests>
...
This primary results plot is adapted from code in (the version you are using is based on regular ggplot code): <https://benchbiostats.com/chapters/one-factor.html#step-6-plot-the-model>
...
More explanation of why it is advised you don't use the word "significant" in the results can be found here (*but if you or your adviser want to, that is fine too, since p-values were \< 0.05*) and examples of writing results can be found here: <https://benchbiostats.com/chapters/one-factor.html#step-7-report-the-model-results>

------------------------------------------------------------------------

# (Optional) One-way ANOVA (hypothesis test)

[This Author](https://benchbiostats.com/chapters/one-factor.html#how-to-generate-anova-tables) advocates that you only run an ANOVA "*if your PI, manager, thesis committee, or journal editor insists that you do ANOVA, and you cannot convince them otherwise.... Note that even though we are generating that table, the computation of the contrast table and all inference from that is not part of the ANOVA.*"
...
For more background see: <https://benchbiostats.com/chapters/one-factor.html#how-to-generate-anova-tables>
