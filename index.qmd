...
-   **FIRST (1) get Git Installed on your computer & your GitHub account setup:**
...
- can follow [these step-by-step instructions for building a quarto website](https://jadeyryan.com/blog/2024-02-19_beginner-quarto-netlify/) BUT STOP when it gets to the "Netlify" section, as you'll want to host your website on GitHub Pages instead - Instructions on that below

    -   And more here on how you can [host a website on GitHub Pages with the "Render to docs" method](https://quarto.org/docs/publishing/github-pages.html#render-to-docs) and here is a [7 min video walkthrough on host a website on GitHub Pages](https://www.youtube.com/watch?v=wZ9pZOFSCko)
