...
-   [(Then this is a good step-by-step tutorial for building a quarto website, although stop when they get to hosting it on Netlify if you want to host it on GitHub )](https://jadeyryan.com/blog/2024-02-19_beginner-quarto-netlify/)
...
-   **THEN (2) Build your Quarto Website & host it online with GitHub Pages** - can follow [these step-by-step instructions for building a quarto website BUT (since it doesn't involved hosting the site on GitHub) SKIP all the stuff towards the end related to hosting it on Netlify](https://jadeyryan.com/blog/2024-02-19_beginner-quarto-netlify/)

    -   And more here on how you can [host a website on GitHub Pages with the "Render to docs" method](https://quarto.org/docs/publishing/github-pages.html#render-to-docs) and here is a [7 min video walkthrough on how to do that](https://www.youtube.com/watch?v=wZ9pZOFSCko)
