...
- If you'd like to host your Quarto Website on GitHub for free (and you've never used Git or GitHub before) there are multiple steps to **FIRST (1) getting Git Installed & GitHub Set up:**
    ...
    -   **OR** if you'd like a more in-depth guide to setting up Git & GitHub linked w/ RStudio:
        1.  Create your free GitHub (website) account [Chapter 4](https://happygitwithr.com/github-acct)
        2.  Install Git (version control) software on your computer [Chapter 6 & 7](https://happygitwithr.com/install-git) NOTE (skip chapter 8) you DO NOT need to install a "git client" (another program) you are going to use RStudio for this
        3.  Connect your Git to GitHub via RStudio (which will allow you to "Commit" then "Push" your files from your computer to GitHub from within RStudio) [Chapters 9 & 10](https://happygitwithr.com/connect-intro.html)

-   **THEN (2) Build your Quarto Website** - can follow [these step-by-step instructions - but SKIP/Ignore the Netlify parts (since you are going to host your webiste on GitHub)](https://jadeyryan.com/blog/2024-02-19_beginner-quarto-netlify/)

-   **FINALLY (3) get the Quarto website you built above hosted on GitHub** by following these instructions ( And here is a step-by-step guide (blog post) for [to use RStudio to push your website to GitHub and hosting your website for free on guithub](https://jadeyryan.com/blog/2023-11-19_publish-quarto-website/)
