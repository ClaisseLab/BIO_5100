...
A curated collection of course resources for learning R, statistical analysis,
data management, reproducible research, and scientific communication.


::: {.callout-tip appearance="simple" title="Start here"}

- **Looking for BIO 5100 Example Code?** Visit the [Example Code](Example_Code.qmd) page.
- **Looking for Advanced R Coding and Statistics Topics (BIO 5150L)?** Go to [BIO 5150L](BIO_5150L.qmd).
...
#### [(Youtube Channel) R for the Rest of Us](https://www.youtube.com/@rfortherestofus/videos)

- A great series of short videos on various R topics. I really like this one because through the videos he uses a lot of newer tidyverse functions so I'm learning new ways to do things.
...
## Coding in RStudio with AI help

#### [Posit Assistant in RStudio and Positron](https://posit.co/products/ai)
...
- If you'd like to host your Quarto Website on GitHub for free (and you've never used Git or GitHub before) there are multiple steps to do this

- **FIRST (1) get Git Installed on your computer & get your GitHub account created:**
  ...
  - **(Then follow this guide to**) [Setting up Git & GitHub linked w/ RStudio](https://rcdsdocs.it.northwestern.edu/tutorials/r/git-with-r.html)

    - **AND** there's a more in-depth guide (online book) to setting up Git & GitHub linked w/ RStudio if you need it: [Happy Git and GitHub for the useR](https://happygitwithr.com/)
...
- **THEN (2) Build your Quarto Website & host it online with GitHub Pages**

- can follow [these step-by-step instructions for building a quarto website](https://jadeyryan.com/blog/2024-02-19_beginner-quarto-netlify/) BUT SKIP anything related to "Netlify" and STOP when it gets to publish to "Netlify" section, as you'll want to host your website on GitHub Pages instead - Instructions on that below

  - And more here on how you' can'll need to [host a website on GitHub Pages with the "Render to docs" method](https://quarto.org/docs/publishing/github-pages.html#render-to-docs) and here is a [7 min video walkthrough on host a website on GitHub Pages](https://www.youtube.com/watch?v=wZ9pZOFSCko)

  - And for more details on building quarto websites [here's a (20 min) video on that](https://www.youtube.com/watch?v=l7r24gTEkEY), which is part of a video playlist [which includes additional in-depth vidoes for other features for building Quarto websites](https://www.youtube.com/playlist?list=PL9HYL-VRX0oTCvag75m8yDjFoJvE-gMxp)

  - And more guidance on details of [building Quarto Websites here](https://quarto.org/docs/websites/#learning-more)

  - And here's a [whole tutorial on the whole process](https://www.cpp.edu/cba/customer-insights-lab/resources/virtual-workshops/portfolio-website-quarto.shtml)
