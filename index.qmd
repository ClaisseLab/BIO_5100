...
-   An external (web based) AI R code writer, can help you figure out what you need to do or debug your code if you don't want to use something integrated within R Studio.
