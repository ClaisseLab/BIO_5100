...
Try to see if you can resolve the conflict using GitHub Desktop. And if that doesn't work then see the relevant sections of [Happy Git and GitHub for the useR](https://happygitwithr.com/), especially **Dealing with push rejection** and **Pull, but you have local work**.
