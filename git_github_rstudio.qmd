...
- Here's an [example of personal github for Dr. Zoë Kitchel](https://github.com/zoekitchel)
- Here's an [example of lab github for Dr. Malin Pinsky's lab](https://github.com/pinskylab)
...
5. Under **Initialize this repository with**:
   ...
   - Under **Choose a license**, select the [**MIT License**](https://choosealicense.com/licenses/mit/). This short, permissive license is a good default for open R analysis code because it allows others to use, modify, and redistribute the code as long as they retain the copyright and license notice. It also states that the code is provided without warranty. The license applies only to material you have the right to share; any included or separately distributed data may have their own permissions or license.
6. Select **Create repository**
8. Once the repo is created, select **Code** and copy its HTTPS URL.
9. In RStudio, select **File → New Project → Version Control → Git**, paste the URL, choose where the project will be stored (*a folder on your computer - I suggest creating a new overall folder named "github repos" where all your github repositories moving forward will be stored*), and select **Create Project**.
...
If you want to keep the contents of `data files/` out of GitHub (they are huge data files and/or you should not share them, ask me if unsure) add these lines to the project’s `.gitignore` file (which you can open and edit in RStudio):
