...
More explanation of why it is optional to (and advised by this author that you don't) use the word "significant" in the results can be found here (*but if you or your adviser want to, that is fine too, since p-value is \< 0.05*) and examples of writing results can be found here: <https://benchbiostats.com/chapters/one-factor.html#step-7-report-the-model-results> and here <https://benchbiostats.com/chapters/one-factor.html#report-the-model-results>
...
More explanation of why it is optional to (and why this author advises you don't need to) use the word "significant" in the results can be found here (*but if you or your adviser want to, that is fine too, since p-value is \< 0.05*) and other examples of writing results can be found here: found here: <https://benchbiostats.com/chapters/one-factor.html#step-7-report-the-model-results> and here <https://benchbiostats.com/chapters/one-factor.html#report-the-model-results>
