...
**Manually entered *made-up* data in "wide" format** (NOT part of typical analysis, as your data would typically already be entered/provided in "long" tidy format. Just here to create made-up data to use below)
